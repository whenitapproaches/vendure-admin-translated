                ...
                <div className="space-y-4 mb-4 flex-shrink-0">
                    <div className="flex flex-col md:flex-row gap-2">
                        ...
                        <Select value={assetType} onValueChange={setAssetType}>
                            ...
                            <SelectContent>
                                <SelectItem value={AssetType.ALL}>{t("All types")}</SelectItem>
                                <SelectItem value={AssetType.IMAGE}>{t("Images")}</SelectItem>
                                <SelectItem value={AssetType.VIDEO}>{t("Video")}</SelectItem>
                                <SelectItem value={AssetType.BINARY}>{t("Binary")}</SelectItem>
                            </SelectContent>
                        </Select>
