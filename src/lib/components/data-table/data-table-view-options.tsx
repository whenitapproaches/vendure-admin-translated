            ...
            <DropdownMenu modal={false}>
                ...
                <DropdownMenuContent align="end" className="overflow-auto">
                    <ScrollArea className="max-h-[60vh]" type="always">
                            ...
                            >
                                {columns.map(column => (
                                    <SortableItem key={column.id} id={column.id}>
                                        ...
                                        >
                                            {(() => {
                                                const display = camelCaseToTitleCase(column.id);
                                                const translatedDisplay = t(display);
                                                return translatedDisplay !== display ? translatedDisplay : display;
                                            })()}
                                        </DropdownMenuCheckboxItem>
                                    </SortableItem>
                                ))}
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem onClick={handleReset}>{t('Reset')}</DropdownMenuItem>
                    </ScrollArea>
                </DropdownMenuContent>
            </DropdownMenu>
        </div>
