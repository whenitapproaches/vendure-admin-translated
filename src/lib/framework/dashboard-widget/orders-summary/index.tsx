        ...
        <DashboardBaseWidget
            ...
            actions={
                <Tabs defaultValue={range} onValueChange={value => setRange(value as Range)}>
                    <TabsList>
                        <TabsTrigger value={Range.Today}>{t("Today")}</TabsTrigger>
                        <TabsTrigger value={Range.Yesterday}>{t("Yesterday")}</TabsTrigger>
                        <TabsTrigger value={Range.ThisWeek}>{t("This Week")}</TabsTrigger>
                        <TabsTrigger value={Range.ThisMonth}>{t("This Month")}</TabsTrigger>
                    </TabsList>
                </Tabs>
            }
        >
            <div className="@container h-full">
                <div className="flex flex-col h-full @md:flex-row gap-8 items-center justify-center @md:justify-evenly text-center tabular-nums">
                    <div className="flex flex-col lg:gap-2">
                        <p className="lg:text-lg text-muted-foreground">{t("Total Orders")}</p>
                    ...
                    <div className="flex flex-col lg:gap-2">
                        <p className="lg:text-lg text-muted-foreground">{t("Total Revenue")}</p>
                        <p className="text-xl @md:text-3xl font-semibold">
                            <AnimatedCurrency
                                animationConfig={{ mass: 0.01, stiffness: 90, damping: 3 }}
