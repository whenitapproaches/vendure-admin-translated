...
// Helper function to create variant schema with translated messages
function createVariantSchema(t: (key: string) => string) {
    return z.object({
        enabled: z.boolean().default(true),
        sku: z.string().min(1, { message: t('SKU is required') }),
