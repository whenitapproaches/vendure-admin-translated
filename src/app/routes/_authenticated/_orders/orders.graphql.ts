...
export const setDraftOrderShippingMethodDocument = graphql(
  `
    mutation SetDraftOrderShippingMethod(
      $orderId: ID!
      $shippingMethodId: ID!
    ) {
...
export const cancelOrderWithItemsDocument = graphql(
  `
    mutation CancelOrderWithItems($orderId: ID!) {
      cancelOrderWithItems(orderId: $orderId) {
        __typename
        ...OrderDetail
      }
    }
