    ...
    return (
        <>
            <Button
                ...
                className="mr-2"
            >
                {t('Add payment to order')} ({formatCurrency(outstandingAmount, currencyCode)})
            </Button>
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[500px]">
                    <DialogHeader>
                        <DialogTitle>
                            {t('Add payment to order')}
                        </DialogTitle>
                        <DialogDescription>
                            {t('Add a manual payment of')} {formatCurrency(outstandingAmount, currencyCode)}
                        </DialogDescription>
                    </DialogHeader>
                    <Form {...form}>
                        <form onSubmit={e => {
                            ...
                            <DialogFooter>
                                ...
                                >
                                    {isSubmitting ? (
                                        ...
                                        `${t('Add payment')} (${formatCurrency(outstandingAmount, currencyCode)})`
                                    )}
                                </Button>
                            </DialogFooter>
                        </form>
